...
use App\Notifications\AddInvoicesWithDataBase;
...
class InvoicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // this use when send notification in the email when add new invoices
        // $user = User::first();
        // Notification::send($user, new AddInvoices($invoice_id));

        $user = User::where('id','!=',auth()->user()->id)->get();
        $Invoices = Invoices::latest()->first();
        Notification::send($user, new AddInvoicesWithDataBase($Invoices));
