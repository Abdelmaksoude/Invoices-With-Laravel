...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قاىمة الفواتير</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu tx-13">
                                                                    @can('تعديل الفاتورة')
                                                                        <a class="dropdown-item" href=" {{ url('edit_invoice') }}/{{ $invoices->id }}">
                                                                            <i
                                                                            class=" text-success fas
                                                                            fa-money-bill"></i>&nbsp;&nbsp;تعديل
                                                                            الفاتورة</a>
                                                                    @endcan
