								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{ route('markAsRead') }}">قراءةالكل</a></span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " style="display: inline">عدد الاشعارات الغير مقروءه : <h5 style="display: inline-block" id="notifications_count">({{ Auth::User()->unreadNotifications->count() }})</h5></p>
									</div>
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-102p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/6.jpg')}}" class="mr-2"></div>
											<div class="mr-3 my-auto">
												<h6>{{ Auth::user()->name }}</h6><span class="ml-1">{{ Auth::user()->email }}</span>
											</div>
										</div>
									</div>
